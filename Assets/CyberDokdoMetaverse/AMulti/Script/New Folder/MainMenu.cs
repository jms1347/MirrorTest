    ...
    public class MainMenu : NetworkBehaviour
    {
        ...
        public void HostSuccess(bool success, string matchID)
        {
            if (success)
            {
                ...
                SpawnPlayerUIPrefab(Player.localPlayer, matchID);
                IDText.text = matchID;
        ...
        public void SpawnPlayerUIPrefab(Player player, string pID)
        {
            GameObject newUIPlayer = Instantiate(UIPlayerPrefab, UIPLayerParent);
            newUIPlayer.GetComponent<PlayerUI>().SetPlayer(player, pID);
        }
